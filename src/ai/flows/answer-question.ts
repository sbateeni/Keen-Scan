...
const AnswerQuestionInputSchema = z.object({
  ...
  question: z
    .string()
    .describe(
      'The question to be answered. Can be a standard question, a true/false statement, or a multiple-choice question.'
    ),
  context: z
    .string()
    .describe('The context text to use for answering the question.'),
  answerType: z
    .enum(['default', 'summary', 'bullet_points', 'true_false', 'multiple_choice'])
    .describe('The format/type of the question being asked.'),
});
...
const AnswerQuestionOutputSchema = z.object({
  answer: z
    .string()
    .describe('The answer to the question based on the provided context.'),
});
...
const answerQuestionFlow = ai.defineFlow(
  ...
  async input => {
    ...
    switch (input.answerType) {
      case 'true_false':
        instruction =
          "The user's question is a true/false statement. Evaluate if it is true or false based on the context and provide a brief justification. Example response: True. The context states that [...].";
        break;
      case 'multiple_choice':
        instruction =
          "The user's question is a multiple-choice question. Determine the correct option (e.g., A, B, C, or D) based on the context and provide a brief justification for your choice. Example response: C. The context mentions that [...], which corresponds to option C.";
        break;
      case 'summary':
        instruction =
